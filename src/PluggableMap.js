...
class PluggableMap extends BaseObject {
  ...
  getEventPixel(event) {
    ...
    const scale = this.viewport_.offsetWidth === viewportPosition.width ? 1 : this.viewport_.offsetWidth / viewportPosition.width;
    const eventPosition =
    ...
    return [
      (eventPosition.clientX - viewportPosition.left) * scale,
      (eventPosition.clientY - viewportPosition.top) * scale,
    ];
  }
